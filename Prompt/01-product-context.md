...
## Domain Model (Entity Scope)

> Entitas-entitas utama dalam sistem ecommerce premium MOEMA:
...
**Aturan naming**: Gunakan nama entitas ini secara konsisten di database, komponen folder `features/`, nama endpoint, hingga state variable.

---

## Aesthetic Direction (The "Premium" Standard)
...
## Halaman, Routes, & Alur Belanja

### Core User Journey

1. **Discovery:** Hero Video/Gambar lebar -> Horizontal Scroll (New Arrival) -> Kumpulan kategori.
2. **Consideration:** Product Listing (PLP) -> Filter warna -> _Quick View Modal_ untuk intip.
...
## Definition of Done (Produk Fitur)

Sebuah fitur tampilan / sistem bagi MOEMA dianggap selesai jika:
...
- [ ] Error state telah dihandle (tidak error putih kosong).
- [ ] Lolos TypeScript strict, tanpa warning.
